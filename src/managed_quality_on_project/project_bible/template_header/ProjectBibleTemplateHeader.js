            ...
            <div>
                {
                    ...
                    <div style={styles.alertMargin}>
                        ...
                        <Alert variant="primary" onClose={() => setShowAlert(false)} dismissible>
                            ...
                            <span>
                                Каждая колонка имеет свой индивидуальный код, в связи с этим:
                                <br/>
                                <br/>
                                1. Если вы хотите изменить существующую колонку, потому что она стала не нужна, а вы
                                хотите добавить новую, то удалите ненужную и с нуля добавьте новую.
                                <br/>
                                2. Изменить параметры колонки можно в любой момент, это не должно привести к конфликтам.
                                <br/>
                                ...
                                добавит ее в конец.
                                <br />
                                7. Изменения в полях выбора и в ячейках с галочками сохраняются по нажатию, текстовые
                                изменения сохраняются как только вы переставляете курсор из редактируемой ячейки в
                                любое другое место.
                            </span>
                        </Alert>
                    </div>
